...
- Instagram は画像が無いと投稿できません。必ず list_media で写真を確認し、
  その中から本文と噛み合うものを選ぶこと。URLを自分で組み立ててはいけません。
  使える写真が無ければ、その日の Instagram 投稿は作らず blocked で残します。
- 写真と本文がずれた投稿は、出さないほうがましです。刺身の写真に炭火の話を載せない。
